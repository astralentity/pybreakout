...
class Breakout(Game):
    ...
    def create_ball(self):
        speed = (random.randinit(-2, 2), c.ball_speed)
    ...
    def create_bricks(self):
        ...
        for row in range(c.row_count):
            for col in range(brick_count):
                ...
                index = random.randinit(0, 10)
                if index < len(special_effect):
